...
import { createSupplier, SupplierData } from "../../../lib/mocks/supplierMocks";

/**
 * Componente Modal para crear un nuevo proveedor
 * Basado en el schema de la tabla `suppliers` (docs/base-de-datos.md, línea 1200)
 * 
 * Campos automáticos (NO se implementan):
 * - id, internal_code, total_billing, created_at, updated_at
 */
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const transformedData = {
        ...
        // Dirección a formato título (si se rellena)
      ...
      const created = await createSupplier(transformedData);
