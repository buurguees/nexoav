...
interface NewSupplierRateModalProps {
  isOpen: boolean;
  onClose: () => void;
  supplierId: string;
...
export function NewSupplierRateModal({
  isOpen,
  onClose,
  supplierId,
  onSave,
}: NewSupplierRateModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const created = await createSupplierRate({
      ...
      setErrors({
        submit: "Error al crear la tarifa. Por favor, inténtalo de nuevo.",
      });
    } finally {
      ...
      >
        ...
        >
          <div>
            ...
            >
              Añadir una nueva tarifa al proveedor
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        >
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              placeholder="Notas sobre la tarifa..."
              style={{
                width: "100%",
                padding: "var(--spacing-sm) var(--spacing-md)",
                borderRadius: "var(--radius-md)",
          ...
          >
            ...
            >
              {isSubmitting ? "Guardando..." : "Crear Tarifa"}
            </button>
          </div>
        </form>
      </motion.div>
