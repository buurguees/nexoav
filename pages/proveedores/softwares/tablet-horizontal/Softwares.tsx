...
/**
 * Página de Softwares - Versión Tablet Horizontal (768px - 1024px, horizontal)
...
export function SoftwaresTabletHorizontal() {
  return (
    <div
      style={{
        display: "flex",
    ...
    >
      ...
      >
        {/* Columna izquierda (70%): Listado de Softwares - PRIORIDAD MÁXIMA */}
        <div
          style={{
            display: "flex",
            flexDirection: "column",
