...
/**
 * Página de Materiales - Versión Tablet Horizontal (768px - 1024px, horizontal)
...
export function MaterialesTabletHorizontal() {
  return (
    <div
      style={{
        display: "flex",
    ...
    >
      ...
      >
        {/* Columna izquierda (70%): Listado de Materiales - PRIORIDAD MÁXIMA */}
        <div
          style={{
            display: "flex",
            flexDirection: "column",
        ...
        >
          ...
          >
            <SpaceBlock
              ...
              description="Tabla/Lista con información de cada Material. Scroll vertical cuando hay muchos Materiales."
            />
          </div>
        </div>
