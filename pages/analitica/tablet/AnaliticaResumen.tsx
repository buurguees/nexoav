...
/**
 * Página de Resumen de Analítica - Versión Tablet Portrait (768px - 1024px)
...
export function AnaliticaResumenTablet() {
  ...
  const blocks = [
    {
      ...
      description: "Resumen general y estadísticas de analítica",
    ...
    {
      title: "Informes",
      label: "Contenido de Informes",
      description: "Informes y análisis de datos",
      color: "rgba(67, 83, 255, 0.1)",
      path: "/analitica/informes",
    },
    {
      title: "Objetivos",
      label: "Contenido de Objetivos",
      description: "Gestión de objetivos y KPIs",
      color: "rgba(0, 200, 117, 0.1)",
      path: "/analitica/objetivos",
    },
    {
      title: "Dashboard",
      label: "Contenido de Dashboard",
      description: "Dashboard personalizado con métricas clave",
      color: "rgba(255, 165, 0, 0.1)",
      path: null,
    },
    {
      title: "Exportaciones",
      label: "Contenido de Exportaciones",
      description: "Exportación de datos y reportes",
