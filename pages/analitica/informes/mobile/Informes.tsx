...
/**
 * Página de Informes - Versión Mobile (< 768px)
 */
...
export function InformesMobile() {
  return (
    <div
      style={{
        display: "flex",
    ...
    >
      ...
      >
        <SpaceBlock label="Total Informes" height="100%" color="rgba(0, 200, 117, 0.2)" borderWidth="2px" />
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "var(--spacing-xs)", flex: 1, minHeight: 0, overflow: "hidden" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: "var(--spacing-xs)", flexShrink: 0 }}>
          <SpaceBlock label="Título: Informes" height="30px" color="var(--background-secondary)" />
