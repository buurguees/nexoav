...
/**
 * Página de Empleados - Versión Tablet Portrait (768px - 1024px)
 * Layout optimizado para tablet portrait con formato reducido de desktop:
...
export function EmpleadosTablet() {
  ...
  return (
    ...
    >
      ...
      >
        <SpaceBlock label="Filtros" height="100%" color="rgba(255, 165, 0, 0.15)" description="Filtros de búsqueda y filtrado de empleados" fontSize={currentConfig.fontSize} />
        <SpaceBlock label="Empleados" height="100%" color="var(--background-secondary)" description="Título de la sección de empleados" fontSize={currentConfig.fontSize} />
        <SpaceBlock label="Herramientas" height="100%" color="rgba(67, 83, 255, 0.15)" description="Herramientas de gestión de empleados" fontSize={currentConfig.fontSize} />
      </div>
