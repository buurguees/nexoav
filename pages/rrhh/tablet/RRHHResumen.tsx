...
/**
 * Página de Resumen de RRHH - Versión Tablet Portrait (768px - 1024px)
...
export function RRHHResumenTablet() {
  ...
  const blocks = [
    {
      ...
      description: "Resumen general y estadísticas de RRHH",
    ...
    },
    {
      ...
      description: "Gestión de trabajadores externos y colaboradores",
    ...
    },
    {
      ...
      description: "Reportes y exportaciones de RRHH",
