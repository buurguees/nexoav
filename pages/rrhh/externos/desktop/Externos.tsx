...
/**
 * Página de Externos - Versión Desktop (> 1024px)
...
export function ExternosDesktop() {
    ...
    >
      ...
      >
        ...
        <SpaceBlock
          ...
          description="Filtros de búsqueda y filtrado de trabajadores externos"
        ...
        <SpaceBlock
          ...
          height="100%"
          color="var(--background-secondary)"
          description="Título de la sección de trabajadores externos"
          fontSize={currentConfig.fontSize}
        />
        ...
        <SpaceBlock
          ...
          description="Herramientas de gestión de trabajadores externos"
          fontSize={currentConfig.fontSize}
        />
      </div>
      ...
      >
        ...
        >
          ...
          >
            {/* Ejemplo de filas de recursos - cada fila representa un externo */}
