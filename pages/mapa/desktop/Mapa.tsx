...
/**
 * Página de Mapa - Versión Desktop (> 1024px)
 * Layout: Navbar superior (100%) + Mapa (60%) + Listado de Ubicaciones (40%)
    ...
    >
      ...
      >
        <SpaceBlock
          ...
          height="100%"
          color="var(--background-secondary)"
          description="Navegación del mapa: vista (satélite/calle), zoom, filtros, acciones"
          fontSize={currentConfig.fontSize}
        />
      </div>

      {/* Contenedor principal: Mapa (60%) + Listado de Ubicaciones (40%) */}
      <div
        style={{
          display: "grid",
      ...
      >
        ...
        >
          ...
          >
            ...
            <SpaceBlock
              ...
              description="Filtros de búsqueda y filtrado del mapa"
              fontSize={currentConfig.fontSize}
            />
            {/* Bloque 2: Título (60%) */}
            <SpaceBlock
              ...
              height="100%"
              color="var(--background-secondary)"
              description="Título de la sección de mapa"
              fontSize={currentConfig.fontSize}
            />
            ...
            <SpaceBlock
              ...
              description="Herramientas de gestión del mapa"
              fontSize={currentConfig.fontSize}
            />
          </div>
        ...
        {/* Columna derecha (40%): Listado de Ubicaciones */}
        <div
          style={{
            display: "flex",
            flexDirection: "column",
        ...
        >
          ...
          >
            ...
            <SpaceBlock
              ...
              height="100%"
              color="var(--background-secondary)"
              description="Título de la sección de ubicaciones"
              fontSize={currentConfig.fontSize}
            />
            {/* Herramientas (30%) */}
            <SpaceBlock
              ...
              height="100%"
              color="rgba(67, 83, 255, 0.15)"
              description="Herramientas de gestión de ubicaciones"
              fontSize={currentConfig.fontSize}
            />
          </div>
