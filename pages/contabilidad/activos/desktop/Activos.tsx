...
/**
 * Página de Activos - Versión Desktop (> 1024px)
...
export function ActivosDesktop() {
      ...
      >
        ...
        >
          ...
          >
            <SpaceBlock
              ...
              description="Filtros: tipo, fecha adquisición, valor, estado, etc."
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              label="Título: Activos"
              height="100%"
              color="var(--background-secondary)"
          ...
          <div style={{ flexShrink: 0, minHeight: currentConfig.tableHeaderHeight }}>
            <SpaceBlock
              ...
              description="Cabecera: código, nombre, tipo, valor, fecha adquisición, amortización, etc."
              fontSize={currentConfig.fontSize}
            />
          </div>
          <div
          ...
          >
            <SpaceBlock
              ...
              description="Tabla/Lista con información de cada activo"
              fontSize={currentConfig.fontSize}
            />
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            />
            <SpaceBlock
              label="Tarjeta 2: Valor Total"
              height="100%"
              color="rgba(67, 83, 255, 0.2)"
              description="Valor total de activos. Comparación con período anterior."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              label="Tarjeta 3: Amortización Acumulada"
              height="100%"
              color="rgba(255, 165, 0, 0.2)"
              description="Amortización acumulada total."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              label="Tarjeta 4: Valor Neto"
              height="100%"
              color="rgba(0, 200, 117, 0.2)"
              description="Valor neto (Valor - Amortización)."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              label="Tarjeta 5: Por Tipo"
              height="100%"
              color="rgba(156, 81, 224, 0.2)"
              description="Distribución de activos por tipo."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
          ...
          >
            ...
            >
              <div style={{ width: "100%", flex: "1 1 50%", minHeight: 0 }}>
                <SpaceBlock
                  label="Gráfico Barras: Activos por Tipo"
                  height="100%"
                  color="rgba(67, 83, 255, 0.15)"
                  description="Distribución de activos por tipo"
                  fontSize={currentConfig.fontSize}
              ...
              <div style={{ width: "100%", flex: "1 1 50%", minHeight: 0 }}>
                <SpaceBlock
                  label="Gráfico Líneas: Evolución Valor"
                  height="100%"
                  color="rgba(0, 200, 117, 0.15)"
                  description="Evolución del valor de activos en el tiempo"
                  fontSize={currentConfig.fontSize}
                />
              </div>
            </div>
            <div style={{ width: "100%", height: "100%", minHeight: 0, display: "flex", flexDirection: "column" }}>
              <SpaceBlock
                ...
                description="Distribución porcentual por tipo de activo"
                fontSize={currentConfig.fontSize}
              />
            </div>
          </div>
