...
/**
 * Página de Activos - Versión Tablet Horizontal (768px - 1024px, horizontal)
...
export function ActivosTabletHorizontal() {
  return (
    <div
      style={{
        display: "flex",
    ...
    >
      ...
      >
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "var(--spacing-xs)", flexShrink: 0 }}>
          <SpaceBlock label="Total Activos" height="60px" color="rgba(0, 200, 117, 0.2)" borderWidth="2px" />
        ...
        <div style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column", gap: "var(--spacing-xs)" }}>
          <SpaceBlock label="Gráfico: Activos por Categoría" height="100%" color="rgba(67, 83, 255, 0.15)" />
        </div>
      </div>
    </div>
  );
