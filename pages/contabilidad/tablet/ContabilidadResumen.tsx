...
/**
 * Página de Resumen de Contabilidad - Versión Tablet Portrait (768px - 1024px)
...
export function ContabilidadResumenTablet() {
  ...
  const blocks = [
    {
      ...
      description: "Resumen general y estadísticas de contabilidad",
    ...
    },
    {
      ...
      description: "Análisis y métricas contables",
      color: "rgba(128, 128, 128, 0.1)",
      path: null,
    },
    {
      title: "Cuadro de Cuentas",
      label: "Contenido de Cuadro de Cuentas",
      description: "Gestión del plan de cuentas contable",
      color: "rgba(67, 83, 255, 0.1)",
      path: "/contabilidad/cuadro-cuentas",
    },
    {
      title: "Balance de Situación",
      label: "Contenido de Balance de Situación",
      description: "Balance general y estados financieros",
      color: "rgba(0, 200, 117, 0.1)",
      path: "/contabilidad/balance-situacion",
    },
    {
      title: "Activos",
      label: "Contenido de Activos",
      description: "Gestión de activos y amortizaciones",
    ...
    },
    {
      ...
      description: "Reportes y exportaciones contables",
