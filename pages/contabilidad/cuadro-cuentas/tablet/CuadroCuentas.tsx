...
/**
 * Página de Cuadro de Cuentas - Versión Tablet Portrait (768px - 1024px, vertical)
 */
...
export function CuadroCuentasTablet() {
  return (
    <div
      style={{
        display: "flex",
    ...
    >
      ...
      >
        ...
        <SpaceBlock label="Por Naturaleza" height="100%" color="rgba(255, 165, 0, 0.2)" borderWidth="2px" />
      </div>
