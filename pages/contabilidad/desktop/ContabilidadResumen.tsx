...
/**
 * Página de Resumen de Contabilidad - Versión Desktop (> 1024px)
 * Dashboard con bloques clickeables para cada subapartado
 * 3 bloques: Cuadro de cuentas, Balance de situación, Activos
 */
...
export function ContabilidadResumenDesktop() {
