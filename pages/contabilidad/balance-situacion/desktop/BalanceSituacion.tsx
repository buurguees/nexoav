...
/**
 * Página de Balance de Situación - Versión Desktop (> 1024px)
...
export function BalanceSituacionDesktop() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Listado de balance de situación */}
        <div
          style={{
            display: "flex",
            flexDirection: "column",
        ...
        >
          ...
          >
            <SpaceBlock
              ...
              description="Filtros: período, tipo, sección, etc."
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              label="Título: Balance de Situación"
              height="100%"
              color="var(--background-secondary)"
            ...
            <SpaceBlock
              ...
              description="Herramientas: exportar, imprimir, etc."
              fontSize={currentConfig.fontSize}
            />
          </div>
          <div style={{ flexShrink: 0, minHeight: currentConfig.tableHeaderHeight }}>
            <SpaceBlock
              ...
              description="Cabecera: concepto, activo, pasivo, patrimonio, etc."
              fontSize={currentConfig.fontSize}
            />
          </div>
          <div
          ...
          >
            <SpaceBlock
              label="Listado de Balance de Situación"
              height="100%"
              color="rgba(0, 200, 117, 0.1)"
              description="Tabla/Lista con información del balance de situación"
              fontSize={currentConfig.fontSize}
            />
          </div>
        </div>
        ...
        >
          ...
          >
            <SpaceBlock
              label="Tarjeta 1: Total Activo"
              height="100%"
              color="rgba(0, 200, 117, 0.2)"
              description="Total de activos. Indicador de tendencia."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              label="Tarjeta 2: Total Pasivo"
              height="100%"
              color="rgba(220, 53, 69, 0.2)"
              description="Total de pasivos. Indicador de tendencia."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              label="Tarjeta 3: Patrimonio Neto"
              height="100%"
              color="rgba(67, 83, 255, 0.2)"
              description="Patrimonio neto (Activo - Pasivo)."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              label="Tarjeta 4: Ratio Solvencia"
              height="100%"
              color="rgba(255, 165, 0, 0.2)"
              description="Ratio de solvencia. Indicador financiero."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              label="Tarjeta 5: Evolución"
              height="100%"
              color="rgba(156, 81, 224, 0.2)"
              description="Evolución respecto al período anterior."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
          ...
          >
            ...
            >
              <div style={{ width: "100%", flex: "1 1 50%", minHeight: 0 }}>
                <SpaceBlock
                  label="Gráfico Barras: Activo vs Pasivo"
                  height="100%"
                  color="rgba(67, 83, 255, 0.15)"
                  description="Comparación de activo y pasivo"
                  fontSize={currentConfig.fontSize}
                />
              </div>
              <div style={{ width: "100%", flex: "1 1 50%", minHeight: 0 }}>
                <SpaceBlock
                  label="Gráfico Líneas: Evolución Patrimonio"
                  height="100%"
                  color="rgba(0, 200, 117, 0.15)"
                  description="Evolución del patrimonio neto en el tiempo"
                  fontSize={currentConfig.fontSize}
                />
              </div>
            </div>
            <div style={{ width: "100%", height: "100%", minHeight: 0, display: "flex", flexDirection: "column" }}>
              <SpaceBlock
                label="Pie Chart: Distribución Activo"
                height="100%"
                color="rgba(156, 81, 224, 0.15)"
                description="Distribución porcentual del activo"
                fontSize={currentConfig.fontSize}
              />
            </div>
          </div>
