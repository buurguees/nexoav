...
/**
 * Página de Calculadora de Alquiler de Pantallas LED - Versión Tablet Horizontal (768px - 1024px, horizontal)
 * Layout optimizado para tablet horizontal, más parecido a desktop:
 * - Header: Filtros, Título, Herramientas
 * - Formulario (60%) + Preview (40%) lado a lado
 */
...
export function CalculadoraTabletHorizontal() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <SpaceBlock label="Calculadora de Pantallas LED" height="100%" color="var(--background-secondary)" fontSize={currentConfig.fontSize} />
        ...
        >
          ...
          >
            <SpaceBlock
              ...
              description="Vista previa del presupuesto calculado"
              fontSize={currentConfig.fontSize}
            />
          </div>
        </div>
