...
/**
 * Página de Proyectos - Versión Tablet Horizontal (768px - 1024px, horizontal)
...
export function ProyectosTabletHorizontal() {
  return (
    <div
      style={{
        display: "flex",
    ...
    >
      ...
      >
        {/* Columna izquierda (70%): Listado de proyectos - PRIORIDAD MÁXIMA */}
        <div
          style={{
            display: "flex",
            flexDirection: "column",
        ...
        >
          ...
          <div style={{ flexShrink: 0, minHeight: "35px" }}>
            <SpaceBlock
              ...
              description="Cabecera con columnas: código, nombre, cliente, estado, presupuesto, fecha inicio"
            />
          </div>
