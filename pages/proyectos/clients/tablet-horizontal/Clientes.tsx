...
/**
 * Página de Clientes - Versión Tablet Horizontal (768px - 1024px, horizontal)
...
export function ClientesTabletHorizontal() {
  return (
    <div
      style={{
        display: "flex",
    ...
    >
      ...
      >
        {/* Columna izquierda (70%): Listado de clientes - PRIORIDAD MÁXIMA */}
        <div
          style={{
            display: "flex",
            flexDirection: "column",
