...
export function EditProductoModal({
  ...
  const [formData, setFormData] = useState({
    ...
    unit: product.unit,
    rental_price_12m: product.rental_price_12m || 0,
    rental_price_18m: product.rental_price_18m || 0,
    rental_price_daily: product.rental_price_daily || 0,
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const updated = await updateInventoryItem(product.id, {
      ...
      setErrors({
        submit:
          "Ha ocurrido un error al actualizar el producto. Revisa los datos e inténtalo de nuevo.",
      });
    } finally {
      ...
      >
        ...
        >
          <div>
            ...
            >
              Actualiza la ficha del producto. Los cambios afectarán a futuros documentos.
            </p>
          </div>
          <button
            onClick={onClose}
