    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <SpaceBlock
              ...
              description="Filtros: categoría, stock, precio, proveedor, etc."
          ...
          <div style={{ flexShrink: 0, minHeight: currentConfig.tableHeaderHeight }}>
            <SpaceBlock
              ...
              description="Cabecera: código, nombre, categoría, stock, precio, proveedor, etc."
              fontSize={currentConfig.fontSize}
            />
          </div>
          <div
          ...
          >
            <SpaceBlock
              ...
              description="Tabla/Lista con información de cada producto"
              fontSize={currentConfig.fontSize}
            />
          </div>
        </div>
        ...
        >
          ...
          >
            <SpaceBlock
              label="Tarjeta 1: Total Productos"
              height="100%"
              color="rgba(0, 200, 117, 0.2)"
              description="Total de productos. Indicador de tendencia."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              label="Tarjeta 2: Stock Bajo"
              height="100%"
              color="rgba(220, 53, 69, 0.2)"
              description="Productos con stock bajo. Alerta de reposición."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              ...
              description="Valor total del inventario. Comparación con período anterior."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              label="Tarjeta 4: Más Vendidos"
              height="100%"
          ...
          >
            ...
            >
              <div style={{ width: "100%", flex: "1 1 50%", minHeight: 0 }}>
                <SpaceBlock
                  label="Gráfico Barras: Productos por Categoría"
                  height="100%"
                  color="rgba(67, 83, 255, 0.15)"
              ...
              <div style={{ width: "100%", flex: "1 1 50%", minHeight: 0 }}>
                <SpaceBlock
                  label="Gráfico Líneas: Evolución Stock"
                  height="100%"
                  color="rgba(0, 200, 117, 0.15)"
                  description="Evolución del stock en el tiempo"
                  fontSize={currentConfig.fontSize}
                />
              </div>
            </div>
