...
/**
 * Página de Servicios - Versión Tablet Horizontal (768px - 1024px, horizontal)
...
export function ServiciosTabletHorizontal() {
  return (
    <div
      style={{
        display: "flex",
    ...
    >
      ...
      >
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "var(--spacing-xs)", flexShrink: 0 }}>
          <SpaceBlock label="Total Servicios" height="60px" color="rgba(0, 200, 117, 0.2)" borderWidth="2px" />
          <SpaceBlock label="Más Contratados" height="60px" color="rgba(67, 83, 255, 0.2)" borderWidth="2px" />
        </div>
        <div style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column", gap: "var(--spacing-xs)" }}>
          <SpaceBlock label="Gráfico: Servicios por Categoría" height="100%" color="rgba(67, 83, 255, 0.15)" />
        </div>
      </div>
    </div>
  );
