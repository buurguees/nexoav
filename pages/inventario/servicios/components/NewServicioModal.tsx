...
export function NewServicioModal({ isOpen, onClose, onCreated }: NewServicioModalProps) {
  const [formData, setFormData] = useState({
    internal_code: "",
    name: "",
    description: "",
    category_id: "",
    subtype: "mano_de_obra",
    base_price: 0,
    cost_price: 0,
    unit: "hora",
    primary_supplier_id: "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrors({
        submit:
          "Ha ocurrido un error al crear el servicio. Revisa los datos e inténtalo de nuevo.",
      });
    } finally {
      ...
      >
        ...
        >
          <div>
            ...
            >
              Alta rápida de servicio de inventario.
            </p>
          </div>
          <button
            onClick={onClose}
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                placeholder="Media Jornada Técnico"
                style={{
                  width: "100%",
                  padding: "var(--spacing-sm) var(--spacing-md)",
                  borderRadius: "var(--radius-md)",
