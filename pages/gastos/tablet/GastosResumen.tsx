...
/**
 * Página de Resumen de Gastos - Versión Tablet Portrait (768px - 1024px)
...
export function GastosResumenTablet() {
  ...
  const blocks = [
    {
      ...
      description: "Resumen general y estadísticas de gastos",
    ...
    },
    {
      ...
      description: "Análisis y métricas de rendimiento de gastos",
      color: "rgba(128, 128, 128, 0.1)",
      path: null,
    },
    {
      title: "Tickets",
      label: "Contenido de Tickets",
      description: "Gestión de tickets de gastos y compras",
      color: "rgba(67, 83, 255, 0.1)",
      path: "/gastos/tickets",
    },
    {
      title: "Categorías",
      label: "Contenido de Categorías",
    ...
    {
      title: "Estadísticas",
      label: "Contenido de Estadísticas",
      description: "Estadísticas detalladas y reportes de gastos",
    ...
    },
    {
      ...
      description: "Reportes y exportaciones de gastos",
