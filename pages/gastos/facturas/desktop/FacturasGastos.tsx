...
/**
 * Página de Facturas de Proveedores - Versión Desktop (> 1024px)
...
export function FacturasGastosDesktop() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Listado de facturas - Ocupa 60% del espacio */}
        <div
          style={{
            display: "flex",
            flexDirection: "column",
        ...
        >
          ...
          >
            ...
            <SpaceBlock
              ...
              description="Filtros de búsqueda: fecha, proveedor, estado, importe, etc."
            ...
            <SpaceBlock
              ...
              height="100%"
              color="var(--background-secondary)"
              description="Título de la sección de facturas de proveedores"
              fontSize={currentConfig.fontSize}
            />
            ...
            <SpaceBlock
              ...
              description="Herramientas: subir factura, exportar, acciones masivas, etc."
              fontSize={currentConfig.fontSize}
            />
          </div>
          ...
          <div style={{ flexShrink: 0, minHeight: currentConfig.tableHeaderHeight }}>
            <SpaceBlock
              ...
              description="Cabecera: fecha, proveedor, número, importe, estado, etc."
              fontSize={currentConfig.fontSize}
            />
          </div>
        ...
        >
          ...
          >
            <SpaceBlock
              ...
              height="100%"
              color="var(--background-secondary)"
              description="Resumen y estadísticas de facturas de proveedores"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              label="Filtro"
          ...
          >
            ...
            <SpaceBlock
              ...
              description="Facturas pendientes de revisión o aprobación."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              ...
              description="Promedio de facturas diarias del período seleccionado."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
