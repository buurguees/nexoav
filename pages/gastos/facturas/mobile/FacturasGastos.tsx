...
/**
 * Página de Facturas de Proveedores - Versión Mobile (< 768px)
...
export function FacturasGastosMobile() {
  return (
    <div
      style={{
        display: "flex",
    ...
    >
      ...
      {/* Listado de Facturas - PRIORIDAD MÁXIMA */}
      <div
        style={{
          display: "flex",
          flexDirection: "column",
      ...
      >
        ...
        >
          <SpaceBlock
            ...
            description="Tabla/Lista con información de cada factura de proveedor. Scroll vertical cuando hay muchas facturas."
          />
        </div>
      </div>
    </div>
