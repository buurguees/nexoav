...
/**
 * Página de Categorías - Versión Desktop (> 1024px)
...
export function CategoriasDesktop() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Listado de categorías - Ocupa 60% del espacio */}
        <div
          style={{
            display: "flex",
            flexDirection: "column",
        ...
        >
          ...
          >
            ...
            <SpaceBlock
              ...
              description="Filtros de búsqueda: nombre, tipo, estado, etc."
            ...
            <SpaceBlock
              ...
              description="Herramientas: añadir categoría, exportar, acciones masivas, etc."
              fontSize={currentConfig.fontSize}
            />
          </div>
          ...
          <div style={{ flexShrink: 0, minHeight: currentConfig.tableHeaderHeight }}>
            <SpaceBlock
              ...
              description="Cabecera: nombre, tipo, descripción, gastos asociados, estado, etc."
              fontSize={currentConfig.fontSize}
            />
          </div>
        ...
        >
          ...
          >
            <SpaceBlock
              ...
              height="100%"
              color="var(--background-secondary)"
              description="Resumen y estadísticas de categorías"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              label="Filtro"
              height="100%"
              color="rgba(255, 165, 0, 0.15)"
              description="Filtro para el resumen: período, tipo, etc."
              fontSize={currentConfig.fontSize}
            />
          </div>
          ...
          >
            ...
            />
            <SpaceBlock
              label="Tarjeta 4: Categoría Más Usada"
              height="100%"
              color="rgba(220, 53, 69, 0.2)"
              description="Categoría con más tickets asociados."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              label="Tarjeta 5: Promedio por Categoría"
              height="100%"
              color="rgba(156, 81, 224, 0.2)"
              description="Promedio de gastos por categoría del período seleccionado."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
