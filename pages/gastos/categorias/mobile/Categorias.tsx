...
/**
 * Página de Categorías - Versión Mobile (< 768px)
...
export function CategoriasMobile() {
  return (
    <div
      style={{
        display: "flex",
      ...
      >
        ...
        >
          <SpaceBlock
            ...
            description="Tabla/Lista con información de cada categoría. Scroll vertical cuando hay muchas categorías."
          />
        </div>
      </div>
    </div>
