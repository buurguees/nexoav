...
/**
 * Página de Tickets - Versión Mobile (< 768px)
...
export function TicketsMobile() {
  return (
    ...
    >
      ...
      {/* Listado de Tickets - PRIORIDAD MÁXIMA */}
      <div
        style={{
          display: "flex",
          flexDirection: "column",
      ...
      >
        ...
        >
          <SpaceBlock
            ...
            description="Tabla/Lista con información de cada ticket. Scroll vertical cuando hay muchos tickets."
          />
        </div>
      </div>
    </div>
