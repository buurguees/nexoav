...
import { createExpense, ExpenseData } from "../../../../lib/mocks/expenseMocks";
...
export function NewGastoModal({ isOpen, onClose, onSave, defaultProjectId }: NewGastoModalProps) {
  ...
  // Cargar pedidos de compra cuando se selecciona proyecto
  useEffect(() => {
    if (formData.project_id) {
      const loadPurchaseOrders = async () => {
        ...
        try {
          ...
          // Solo pedidos pendientes sin gasto vinculado
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrors({ submit: "Error al crear el gasto. Por favor, inténtalo de nuevo." });
    } finally {
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "var(--spacing-md)" }}>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="Ej: Servicio Técnico Sonido Evento X"
                      />
                      {errors.description && (
                        <span
                          style={{
