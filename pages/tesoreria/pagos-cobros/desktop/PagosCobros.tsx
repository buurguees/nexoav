...
/**
 * Página de Pagos y Cobros - Versión Desktop (> 1024px)
...
export function PagosCobrosDesktop() {
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <SpaceBlock
              ...
              description="Filtros: tipo, fecha, estado, importe, cliente/proveedor, etc."
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              label="Título: Pagos y Cobros"
              height="100%"
              color="var(--background-secondary)"
          ...
          <div style={{ flexShrink: 0, minHeight: currentConfig.tableHeaderHeight }}>
            <SpaceBlock
              ...
              description="Cabecera: tipo, fecha, concepto, importe, estado, cliente/proveedor, cuenta, etc."
              fontSize={currentConfig.fontSize}
            />
          </div>
          <div
          ...
          >
            <SpaceBlock
              label="Listado de Pagos y Cobros"
              height="100%"
              color="rgba(0, 200, 117, 0.1)"
              description="Tabla/Lista con información de cada pago y cobro"
              fontSize={currentConfig.fontSize}
            />
          </div>
        </div>
        ...
        >
          ...
          >
            <SpaceBlock
              label="Tarjeta 1: Total Pagos"
              height="100%"
              color="rgba(220, 53, 69, 0.2)"
              description="Total de pagos realizados. Indicador de tendencia."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              label="Tarjeta 2: Total Cobros"
              height="100%"
              color="rgba(0, 200, 117, 0.2)"
              description="Total de cobros realizados. Indicador de tendencia."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              ...
              description="Pagos y cobros pendientes. Alerta de seguimiento."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              label="Tarjeta 4: Vencidos"
              height="100%"
              color="rgba(220, 53, 69, 0.2)"
              description="Pagos y cobros vencidos. Requiere atención."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              label="Tarjeta 5: Diferencia"
              height="100%"
              color="rgba(67, 83, 255, 0.2)"
              description="Diferencia entre cobros y pagos. Indicador positivo/negativo."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
          ...
          >
            ...
            >
              <div style={{ width: "100%", flex: "1 1 50%", minHeight: 0 }}>
                <SpaceBlock
                  label="Gráfico Barras: Pagos vs Cobros"
                  height="100%"
                  color="rgba(67, 83, 255, 0.15)"
                  description="Comparación de pagos y cobros por período"
                  fontSize={currentConfig.fontSize}
                />
              </div>
              <div style={{ width: "100%", flex: "1 1 50%", minHeight: 0 }}>
                <SpaceBlock
                  ...
                  height="100%"
                  color="rgba(0, 200, 117, 0.15)"
                  description="Evolución de pagos y cobros en el tiempo"
                  fontSize={currentConfig.fontSize}
                />
              </div>
            </div>
            <div style={{ width: "100%", height: "100%", minHeight: 0, display: "flex", flexDirection: "column" }}>
              <SpaceBlock
                label="Pie Chart: Distribución por Estado"
                height="100%"
                color="rgba(156, 81, 224, 0.15)"
                description="Distribución porcentual por estado"
                fontSize={currentConfig.fontSize}
              />
            </div>
          </div>
