...
/**
 * Página de Pagos y Cobros - Versión Mobile (< 768px)
 */
...
export function PagosCobrosMobile() {
  return (
    <div
      style={{
        display: "flex",
    ...
    >
      ...
      >
        <SpaceBlock label="Total Pagos" height="100%" color="rgba(220, 53, 69, 0.2)" borderWidth="2px" />
        <SpaceBlock label="Total Cobros" height="100%" color="rgba(0, 200, 117, 0.2)" borderWidth="2px" />
        <SpaceBlock label="Pendientes" height="100%" color="rgba(255, 165, 0, 0.2)" borderWidth="2px" />
        <SpaceBlock label="Vencidos" height="100%" color="rgba(220, 53, 69, 0.2)" borderWidth="2px" />
      </div>
      <div style={{ display: "flex", flexDirection: "column", gap: "var(--spacing-xs)", flex: 1, minHeight: 0, overflow: "hidden" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: "var(--spacing-xs)", flexShrink: 0 }}>
          <SpaceBlock label="Título: Pagos y Cobros" height="30px" color="var(--background-secondary)" />
