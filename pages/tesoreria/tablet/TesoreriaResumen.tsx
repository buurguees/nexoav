...
/**
 * Página de Resumen de Tesorería - Versión Tablet Portrait (768px - 1024px)
...
export function TesoreriaResumenTablet() {
  ...
  const blocks = [
    {
      ...
      description: "Resumen general y estadísticas de tesorería",
    ...
    },
    {
      ...
      description: "Análisis y métricas de rendimiento financiero",
      color: "rgba(128, 128, 128, 0.1)",
      path: null,
    },
    {
      title: "Cuentas Bancarias",
      label: "Contenido de Cuentas Bancarias",
    ...
    },
    {
      ...
      label: "Contenido de Pagos y Cobros",
      description: "Gestión de pagos y cobros pendientes",
      color: "rgba(156, 81, 224, 0.1)",
      path: "/tesoreria/pagos-cobros",
    },
    {
      title: "Reportes",
      label: "Contenido de Reportes",
      description: "Reportes y exportaciones de tesorería",
