...
/**
 * Página de Cuentas Bancarias - Versión Mobile (< 768px)
 */
...
export function CuentasBancariasMobile() {
  return (
    <div
      style={{
        display: "flex",
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "var(--spacing-xs)", flex: 1, minHeight: 0, overflow: "hidden" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: "var(--spacing-xs)", flexShrink: 0 }}>
          <SpaceBlock label="Título: Cuentas Bancarias" height="30px" color="var(--background-secondary)" />
