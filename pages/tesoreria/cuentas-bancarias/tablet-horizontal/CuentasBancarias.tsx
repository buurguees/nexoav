...
/**
 * Página de Cuentas Bancarias - Versión Tablet Horizontal (768px - 1024px, horizontal)
...
export function CuentasBancariasTabletHorizontal() {
  return (
    <div
      style={{
        display: "flex",
    ...
    >
      ...
      >
        ...
        <div style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column", gap: "var(--spacing-xs)" }}>
          <SpaceBlock label="Gráfico: Saldo por Banco" height="100%" color="rgba(67, 83, 255, 0.15)" />
        </div>
      </div>
    </div>
  );
