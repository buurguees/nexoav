...
/**
 * Página de Resumen de Facturación - Versión Tablet Portrait (768px - 1024px)
...
export function FacturacionResumenTablet() {
  ...
  const blocks = [
    {
      ...
      description: "Resumen general y estadísticas de facturación",
    ...
    },
    {
      ...
      description: "Análisis y métricas de facturación",
    ...
    {
      title: "Proformas",
      label: "Contenido de Proformas",
      description: "Gestión de proformas y facturas proforma",
      color: "rgba(0, 200, 117, 0.1)",
      path: "/facturacion/proformas",
    },
    {
      title: "Facturas",
    ...
    },
    {
      ...
      label: "Contenido de Rectificativas",
      description: "Gestión de facturas rectificativas",
      color: "rgba(220, 53, 69, 0.1)",
      path: "/facturacion/rectificativas",
    },
  ];
