...
/**
 * Página de Rectificativas - Versión Desktop (> 1024px)
...
export function RectificativasDesktop() {
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <SpaceBlock
              label="Listado de Rectificativas"
              height="100%"
              color="rgba(0, 200, 117, 0.1)"
              description="Tabla/Lista con información de cada factura rectificativa"
              fontSize={currentConfig.fontSize}
            />
          </div>
        </div>
        ...
        >
          ...
          >
            <SpaceBlock
              label="Tarjeta 1: Total Rectificativas"
              height="100%"
              color="rgba(0, 200, 117, 0.2)"
              description="Total de facturas rectificativas. Indicador de tendencia."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              label="Tarjeta 2: Rectificativas Aplicadas"
              height="100%"
              color="rgba(67, 83, 255, 0.2)"
              description="Número de rectificativas aplicadas. Tasa de aplicación."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              ...
              description="Importe total de rectificativas. Comparación con período anterior."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              ...
              description="Rectificativas pendientes de aplicación."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              ...
              description="Promedio de importe por rectificativa."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
          ...
          >
            ...
            >
              <div style={{ width: "100%", flex: "1 1 50%", minHeight: 0 }}>
                <SpaceBlock
                  label="Gráfico Barras: Rectificativas por Estado"
                  height="100%"
                  color="rgba(67, 83, 255, 0.15)"
                  description="Distribución de rectificativas por estado"
                  fontSize={currentConfig.fontSize}
                />
              </div>
              <div style={{ width: "100%", flex: "1 1 50%", minHeight: 0 }}>
                <SpaceBlock
                  ...
                  height="100%"
                  color="rgba(0, 200, 117, 0.15)"
                  description="Evolución de rectificativas en el tiempo"
                  fontSize={currentConfig.fontSize}
                />
              </div>
            </div>
