...
import { createSalesDocument, SalesDocumentData } from "../../../../lib/mocks/salesDocumentsMocks";
import { createSalesDocumentLine, calculateDocumentTotals } from "../../../../lib/mocks/salesDocumentLinesMocks";
...
export function NewProformaModal({ isOpen, onClose, onSave }: NewProformaModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const document = await createSalesDocument({
        ...
        // Usamos "enviado" como estado inicial para proformas
        status: "enviado",
      ...
      setErrors({ submit: "Error al crear la proforma. Por favor, inténtalo de nuevo." });
    } finally {
