...
/**
 * Página de Proformas - Versión Tablet Portrait (768px - 1024px, vertical)
 */
...
export function ProformasTablet() {
  return (
    <div
      style={{
        display: "flex",
    ...
    >
      ...
      >
        <SpaceBlock label="Total Proformas" height="100%" color="rgba(0, 200, 117, 0.2)" borderWidth="2px" />
