...
/**
 * Página de Proformas - Versión Desktop (> 1024px)
...
export function ProformasDesktop() {
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <SpaceBlock
              ...
              description="Tabla/Lista con información de cada proforma"
              fontSize={currentConfig.fontSize}
            />
          </div>
        </div>
        ...
        >
          ...
          >
            <SpaceBlock
              label="Tarjeta 1: Total Proformas"
              height="100%"
              color="rgba(0, 200, 117, 0.2)"
              description="Total de proformas. Indicador de tendencia."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              label="Tarjeta 2: Proformas Convertidas"
              height="100%"
              color="rgba(67, 83, 255, 0.2)"
              description="Número de proformas convertidas a factura. Tasa de conversión."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              ...
              description="Importe total de proformas. Comparación con período anterior."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              ...
              description="Proformas pendientes de conversión."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              ...
              description="Promedio de importe por proforma."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
          ...
          >
            ...
            >
              <div style={{ width: "100%", flex: "1 1 50%", minHeight: 0 }}>
                <SpaceBlock
                  label="Gráfico Barras: Proformas por Estado"
                  height="100%"
                  color="rgba(67, 83, 255, 0.15)"
                  description="Distribución de proformas por estado"
                  fontSize={currentConfig.fontSize}
                />
              </div>
              <div style={{ width: "100%", flex: "1 1 50%", minHeight: 0 }}>
                <SpaceBlock
                  ...
                  height="100%"
                  color="rgba(0, 200, 117, 0.15)"
                  description="Evolución de proformas en el tiempo"
                  fontSize={currentConfig.fontSize}
                />
              </div>
            </div>
