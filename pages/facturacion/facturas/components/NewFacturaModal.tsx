...
interface NewFacturaModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export function NewFacturaModal({ isOpen, onClose, onSave }: NewFacturaModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrors({ submit: "Error al crear la factura. Por favor, inténtalo de nuevo." });
    } finally {
