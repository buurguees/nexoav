...
/**
 * Página de Facturas - Versión Tablet Portrait (768px - 1024px, vertical)
 */
...
export function FacturasTablet() {
  return (
    <div
      style={{
        display: "flex",
    ...
    >
      ...
      >
        <SpaceBlock label="Total Facturas" height="100%" color="rgba(0, 200, 117, 0.2)" borderWidth="2px" />
