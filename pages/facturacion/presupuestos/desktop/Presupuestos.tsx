    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <SpaceBlock
              label="Tarjeta 1: Total Presupuestos"
              height="100%"
              color="rgba(0, 200, 117, 0.2)"
              description="Total de presupuestos. Indicador de tendencia."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              label="Tarjeta 2: Presupuestos Aceptados"
              height="100%"
              color="rgba(67, 83, 255, 0.2)"
              description="Número de presupuestos aceptados. Tasa de conversión."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              ...
              description="Importe total de presupuestos. Comparación con período anterior."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              ...
              description="Presupuestos pendientes de respuesta."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
              ...
              description="Promedio de importe por presupuesto."
              borderWidth="2px"
              fontSize={currentConfig.fontSize}
            />
            <SpaceBlock
          ...
          >
            ...
            >
              <div style={{ width: "100%", flex: "1 1 50%", minHeight: 0 }}>
                <SpaceBlock
                  label="Gráfico Barras: Presupuestos por Estado"
                  height="100%"
                  color="rgba(67, 83, 255, 0.15)"
                  description="Distribución de presupuestos por estado"
                  fontSize={currentConfig.fontSize}
                />
              </div>
              <div style={{ width: "100%", flex: "1 1 50%", minHeight: 0 }}>
                <SpaceBlock
                  ...
                  description="Evolución de presupuestos en el tiempo"
                  fontSize={currentConfig.fontSize}
                />
              </div>
            </div>
