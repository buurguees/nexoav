...
interface NewPresupuestoModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export function NewPresupuestoModal({ isOpen, onClose, onSave }: NewPresupuestoModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrors({ submit: "Error al crear el presupuesto. Por favor, inténtalo de nuevo." });
    } finally {
