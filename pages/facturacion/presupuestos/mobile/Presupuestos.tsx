...
/**
 * Página de Presupuestos - Versión Mobile (< 768px)
 */
...
export function PresupuestosMobile() {
  return (
    <div
      style={{
        display: "flex",
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "var(--spacing-xs)", flex: 1, minHeight: 0, overflow: "hidden" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: "var(--spacing-xs)", flexShrink: 0 }}>
          <SpaceBlock label="Título: Presupuestos" height="30px" color="var(--background-secondary)" />
