...
/**
 * Página de Resumen de Facturación - Versión Desktop (> 1024px)
 * Dashboard con bloques clickeables para cada subapartado
 * 4 bloques: Presupuestos, Proformas, Facturas, Rectificativas
 */
...
export function FacturacionResumenDesktop() {
  ...
  const subItems = [
    ...
    },
    {
      ...
      description: "Gestión de facturas emitidas y recibidas",
      color: "rgba(156, 81, 224, 0.1)",
    },
    {
      label: "Rectificativas",
      path: "/facturacion/rectificativas",
      description: "Gestión de facturas rectificativas y notas de crédito",
