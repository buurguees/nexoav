...
/**
 * Página de Calendario - Versión Tablet Portrait (768px - 1024px)
 * Layout optimizado para tablet portrait:
 * - Navbar superior (100%)
 * - Calendario principal (70% del espacio vertical)
 * - Listado de Tareas compacto (30% del espacio vertical)
...
export function CalendarioTablet() {
  ...
  return (
    ...
    >
      ...
      {/* Contenedor principal: Calendario (70%) + Listado de Tareas (30%) */}
      <div
        style={{
          display: "flex",
          flexDirection: "column",
      ...
      >
        {/* Sección Calendario (70% del espacio vertical) */}
        <div
          style={{
            display: "flex",
            flexDirection: "column",
        ...
        {/* Sección Listado de Tareas (30% del espacio vertical) */}
        <div
          style={{
            display: "flex",
            flexDirection: "column",
