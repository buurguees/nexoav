...
/**
 * Página de Plantillas - Versión Tablet Portrait (768px - 1024px)
 * Layout optimizado para tablet portrait:
 * - Header: Filtros, Título, Herramientas
 * - Listado de Plantillas (arriba, scrollable)
 * - Editor/Vista Previa (abajo, compacto)
 */
...
export function PlantillasTablet() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <SpaceBlock label="Plantillas" height="100%" color="var(--background-secondary)" fontSize={currentConfig.fontSize} />
      ...
      <div
        style={{
          ...
          flexDirection: "column",
          gap: currentConfig.gap,
          height: currentConfig.editorHeight,
          flexShrink: 0,
          minHeight: currentConfig.editorHeight,
          overflow: "hidden",
        }}
      >
        <div
