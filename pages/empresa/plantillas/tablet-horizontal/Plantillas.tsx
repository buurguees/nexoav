...
/**
 * Página de Plantillas - Versión Tablet Horizontal (768px - 1024px, horizontal)
 * Layout optimizado para tablet horizontal, más parecido a desktop:
 * - Header: Filtros, Título, Herramientas
 * - Listado (60%) + Editor/Vista Previa (40%) lado a lado
 */
...
export function PlantillasTabletHorizontal() {
  ...
  return (
    ...
    >
      ...
      {/* Contenido principal: Listado (60%) + Editor (40%) */}
      <div
        style={{
          display: "grid",
