...
/**
 * Página de Plantillas - Versión Desktop (> 1024px)
 * Layout optimizado para gestionar plantillas de la empresa
 * Listado (60%) + Editor/Vista Previa (40%)
...
export function PlantillasDesktop() {
