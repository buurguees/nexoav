...
/**
 * Página de Documentación - Versión Tablet Horizontal (768px - 1024px, horizontal)
 * Layout optimizado para tablet horizontal, más parecido a desktop:
 * - Header: Filtros, Título, Herramientas
 * - Listado (60%) + Vista Previa (40%) lado a lado
 */
...
export function DocumentacionTabletHorizontal() {
