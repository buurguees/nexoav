...
/**
 * Página de Datos Fiscales - Versión Tablet Portrait (768px - 1024px)
 ...
 * - Panel de Información/Validación (debajo del formulario)
 */
...
export function DatosFiscalesTablet() {
  ...
  return (
    ...
    >
      ...
      {/* Panel de Información/Validación (compacto abajo) */}
      <div
        style={{
          display: "grid",
