...
/**
 * Página de Resumen de Empresa - Versión Desktop (> 1024px)
 * Dashboard con bloques clickeables para cada subapartado
 * 5 bloques: Datos Fiscales, Preferencias, Plantillas, Conectividad, Documentación
 */
...
export function EmpresaResumenDesktop() {
  ...
  const subItems = [
    {
      ...
      path: "/empresa/datos-fiscales",
      description: "Información fiscal y datos de la empresa",
      color: "rgba(67, 83, 255, 0.1)",
    },
    {
      label: "Preferencias",
      path: "/empresa/preferencias",
      description: "Configuración y preferencias del sistema",
      color: "rgba(0, 200, 117, 0.1)",
    },
    {
      label: "Plantillas",
      path: "/empresa/plantillas",
      description: "Gestión de plantillas y documentos",
      color: "rgba(156, 81, 224, 0.1)",
    },
    {
      label: "Conectividad",
      path: "/empresa/conectividad",
      description: "Integraciones y conexiones externas",
      color: "rgba(255, 165, 0, 0.1)",
    },
    {
      label: "Documentación",
      path: "/empresa/documentacion",
      description: "Documentos y archivos de la empresa",
      color: "rgba(220, 53, 69, 0.1)",
    },
  ];

  // 5 bloques: 2 columnas, 3 filas (primeros 4 en 2x2, último ocupa 2 columnas)
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Último bloque ocupa 2 columnas */}
        <div style={{ gridColumn: "1 / 3" }}>
          <DashboardBlock
            label={subItems[4].label}
            description={subItems[4].description}
            path={subItems[4].path}
            color={subItems[4].color}
            fontSize={currentConfig.fontSize}
          />
        </div>
      </div>
