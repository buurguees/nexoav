...
/**
 * Listado de clientes para tablet (portrait)
 * Muestra columnas adaptadas: Número, Nombre, Estado, Facturado, Pendiente
 */
export function ClientList({
  ...
  const calculatePendingAmountWithVAT = (client: Client): number => {
    if (!client.pending_amount) return 0;
    if (client.vat_exempt) return client.pending_amount;
    let vatRate = 0;
    switch (client.vat_type) {
      case "general": vatRate = 0.21; break;
      case "reduced": vatRate = 0.10; break;
      case "super_reduced": vatRate = 0.04; break;
      case "exempt": return client.pending_amount;
      default: vatRate = 0.21;
    }
    return client.pending_amount * (1 + vatRate);
  };

  // Grid compartido para header y filas - responsive con porcentajes
  const gridTemplateColumns = "60px minmax(150px, 1fr) 60px 70px 70px";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div style={{ textAlign: "left" }}>Nº</div>
            ...
            clients.map((client) => (
              ...
              >
                ...
                <div
                  ...
                  title={client.commercial_name || client.name || ""}
                >
                ...
                >
                  {formatCurrency(calculatePendingAmountWithVAT(client))}
                </div>
                <div
                  style={{
                    fontSize: "12px",
