...
export function Calendar18({
  ...
  React.useEffect(() => {
    ...
    const cells = calendarContainer.querySelectorAll('.calendar-empresa-cell-tablet');
    ...
    cells.forEach((cell) => {
      ...
      dayTasks.forEach((task) => {
        ...
        taskBar.style.cssText = `
          ...
          display: flex;
          align-items: center;
          padding-left: 6px; /* TABLET: padding reducido */
          padding-right: 6px;
          cursor: pointer;
        ...
        titleSpan.style.cssText = `
          font-size: 10px; /* TABLET: fuente más pequeña */
  ...
  return (
    <>
      <div ref={calendarRef} className={cn("calendar-empresa-container-tablet w-full", className)} style={{ position: "relative" }}>
        <Calendar
          mode="single"
          selected={date}
          ...
          className="w-full"
          classNames={{
            months: "calendar-empresa-months-tablet",
            month: "calendar-empresa-month-tablet",
            caption: "calendar-empresa-caption-tablet",
            caption_label: "calendar-empresa-caption-label-tablet",
            nav: "calendar-empresa-nav-tablet",
            nav_button: "calendar-empresa-nav-button-tablet",
            nav_button_previous: "calendar-empresa-nav-button-tablet calendar-empresa-nav-button-previous-tablet",
            nav_button_next: "calendar-empresa-nav-button-tablet calendar-empresa-nav-button-next-tablet",
            table: "calendar-empresa-table-tablet",
            head_row: "calendar-empresa-head-row-tablet",
            head_cell: "calendar-empresa-head-cell-tablet",
            row: "calendar-empresa-row-tablet",
            cell: "calendar-empresa-cell-tablet",
            day: "calendar-empresa-day-tablet",
            day_range_start: "calendar-empresa-day-tablet day-range-start-tablet",
            day_range_end: "calendar-empresa-day-tablet day-range-end-tablet",
            day_selected: "calendar-empresa-day-tablet",
            day_today: "calendar-empresa-day-tablet day-today-tablet",
            day_outside: "calendar-empresa-day-tablet day-outside-tablet",
            day_disabled: "calendar-empresa-day-tablet",
            day_range_middle: "calendar-empresa-day-tablet",
            day_hidden: "calendar-empresa-day-hidden-tablet",
          }}
        />
      </div>
      <DayPopup
