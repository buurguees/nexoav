...
import { TaskCategoryDot } from "../../tasks/tablet/TaskCategoryDot";
...
export function Calendar3Months({
  ...
  React.useEffect(() => {
    ...
    const cells = calendarContainer.querySelectorAll('.calendar-cell-tablet');
    
    cells.forEach((cell) => {
      // Limpiar puntos anteriores
      const existingDots = cell.querySelectorAll('.task-dot-container-tablet');
      ...
      if (!dayDate || isNaN(dayDate.getTime())) {
        ...
        const monthElement = cell.closest('.calendar-month-tablet');
        if (!monthElement) return;
        
        // Obtener el texto del caption del mes (ej: "noviembre 2025")
        const captionLabel = monthElement.querySelector('.calendar-caption-label-tablet');
        ...
        const isOutside = dayButton.classList.contains('day-outside-tablet') || dayButton.classList.contains('day-outside');
      ...
      // Crear contenedor para los puntos - TABLET: más compacto
      const dotsContainer = document.createElement('div');
      dotsContainer.className = 'task-dot-container-tablet';
      ...
      // TABLET: puntos más pequeños (5px en lugar de 6px)
    ...
    return () => {
      ...
      const containers = calendarContainer.querySelectorAll('.task-dot-container-tablet');
  ...
  return (
    <div 
      ref={calendarRef} 
      className={cn("calendar-container-tablet w-full", className)} 
    ...
    >
      <Calendar
        ...
        className="w-full"
        classNames={{
          months: "calendar-months-tablet",
          month: "calendar-month-tablet",
          caption: "calendar-caption-tablet",
          caption_label: "calendar-caption-label-tablet",
          nav: "calendar-nav-tablet",
          nav_button: "calendar-nav-button-tablet",
          nav_button_previous: "calendar-nav-button-tablet calendar-nav-button-previous-tablet",
          nav_button_next: "calendar-nav-button-tablet calendar-nav-button-next-tablet",
          table: "calendar-table-tablet",
          head_row: "calendar-head-row-tablet",
          head_cell: "calendar-head-cell-tablet",
          row: "calendar-row-tablet",
          cell: "calendar-cell-tablet",
          day: "calendar-day-tablet",
          day_range_start: "calendar-day-tablet day-range-start-tablet",
          day_range_end: "calendar-day-tablet day-range-end-tablet",
          day_selected: "calendar-day-tablet",
          day_today: "calendar-day-tablet day-today-tablet",
          day_outside: "calendar-day-tablet day-outside-tablet",
          day_disabled: "calendar-day-tablet",
          day_range_middle: "calendar-day-tablet",
          day_hidden: "calendar-day-hidden-tablet",
        }}
      />
      <DayPopup
        open={isPopupOpen}
