...
export function Calendar18({
  ...
  React.useEffect(() => {
    ...
    const cells = calendarContainer.querySelectorAll('.calendar-empresa-cell');
    ...
    cells.forEach((cell) => {
      ...
      dayTasks.forEach((task) => {
        ...
        // 33px = posición inicial después del número + espacio
        // 25px = 20px (altura del TaskBar) + 3px de espacio entre TaskBars + 2px adicional
        const topPosition = 33 + taskRow * 25;
  ...
  return (
    <>
      <div ref={calendarRef} className={cn("calendar-empresa-container w-full", className)} style={{ position: "relative" }}>
        <Calendar
          mode="single"
          selected={date}
          ...
          locale={es}
          weekStartsOn={1}
          className="w-full rounded-lg border [--cell-size:calc(2.75rem+3.75rem)] md:[--cell-size:calc(3.5rem+3.75rem)] lg:[--cell-size:calc(4rem+3.75rem)]"
          classNames={{
            months: "calendar-empresa-months",
            month: "calendar-empresa-month",
            caption: "calendar-empresa-caption",
            caption_label: "calendar-empresa-caption-label",
            nav: "calendar-empresa-nav",
            nav_button: "calendar-empresa-nav-button",
            nav_button_previous: "calendar-empresa-nav-button calendar-empresa-nav-button-previous",
            nav_button_next: "calendar-empresa-nav-button calendar-empresa-nav-button-next",
            table: "calendar-empresa-table",
            head_row: "calendar-empresa-head-row",
            head_cell: "calendar-empresa-head-cell",
            row: "calendar-empresa-row",
            cell: "calendar-empresa-cell",
            day: "calendar-empresa-day",
            day_range_start: "calendar-empresa-day day-range-start",
            day_range_end: "calendar-empresa-day day-range-end",
            day_selected: "calendar-empresa-day",
            day_today: "calendar-empresa-day day-today",
            day_outside: "calendar-empresa-day day-outside",
            day_disabled: "calendar-empresa-day",
            day_range_middle: "calendar-empresa-day",
            day_hidden: "calendar-empresa-day-hidden",
          }}
        />
      </div>
      <DayPopup
