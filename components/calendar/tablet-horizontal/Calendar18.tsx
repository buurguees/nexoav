...
export function Calendar18({
  ...
  React.useEffect(() => {
    ...
    const cells = calendarContainer.querySelectorAll('.calendar-empresa-cell-tablet-horizontal');
    ...
    cells.forEach((cell) => {
      ...
      dayTasks.forEach((task) => {
        ...
        // TABLET HORIZONTAL: posición inicial después del número + espacio (reducido)
        // TABLET HORIZONTAL: altura del TaskBar reducida + espacio entre TaskBars
        const topPosition = 26 + taskRow * 18; // TABLET HORIZONTAL: valores optimizados para 3+ tareas
        ...
        taskBar.style.cssText = `
          ...
          right: 0;
          top: ${topPosition}px;
          height: 14px; /* TABLET HORIZONTAL: altura optimizada para 3+ tareas por día */
          background-color: ${barColor};
          opacity: ${opacity};
          display: flex;
          align-items: center;
          padding-left: 6px; /* TABLET HORIZONTAL: padding reducido */
          padding-right: 6px;
          cursor: pointer;
        ...
        titleSpan.style.cssText = `
          font-size: 10px; /* TABLET HORIZONTAL: fuente más pequeña */
  ...
  return (
    <>
      <div ref={calendarRef} className={cn("calendar-empresa-container-tablet-horizontal w-full", className)} style={{ position: "relative" }}>
        <Calendar
          mode="single"
          selected={date}
          ...
          className="w-full"
          classNames={{
            months: "calendar-empresa-months-tablet-horizontal",
            month: "calendar-empresa-month-tablet-horizontal",
            caption: "calendar-empresa-caption-tablet-horizontal",
            caption_label: "calendar-empresa-caption-label-tablet-horizontal",
            nav: "calendar-empresa-nav-tablet-horizontal",
            nav_button: "calendar-empresa-nav-button-tablet-horizontal",
            nav_button_previous: "calendar-empresa-nav-button-tablet-horizontal calendar-empresa-nav-button-previous-tablet-horizontal",
            nav_button_next: "calendar-empresa-nav-button-tablet-horizontal calendar-empresa-nav-button-next-tablet-horizontal",
            table: "calendar-empresa-table-tablet-horizontal",
            head_row: "calendar-empresa-head-row-tablet-horizontal",
            head_cell: "calendar-empresa-head-cell-tablet-horizontal",
            row: "calendar-empresa-row-tablet-horizontal",
            cell: "calendar-empresa-cell-tablet-horizontal",
            day: "calendar-empresa-day-tablet-horizontal",
            day_range_start: "calendar-empresa-day-tablet-horizontal day-range-start-tablet-horizontal",
            day_range_end: "calendar-empresa-day-tablet-horizontal day-range-end-tablet-horizontal",
            day_selected: "calendar-empresa-day-tablet-horizontal",
            day_today: "calendar-empresa-day-tablet-horizontal day-today-tablet-horizontal",
            day_outside: "calendar-empresa-day-tablet-horizontal day-outside-tablet-horizontal",
            day_disabled: "calendar-empresa-day-tablet-horizontal",
            day_range_middle: "calendar-empresa-day-tablet-horizontal",
            day_hidden: "calendar-empresa-day-hidden-tablet-horizontal",
          }}
        />
      </div>
      <DayPopup
