...
import { TaskCategoryDot } from "../../tasks/mobile/TaskCategoryDot";
...
export function Calendar3Months({
  ...
  React.useEffect(() => {
    ...
    const cells = calendarContainer.querySelectorAll('.calendar-cell-mobile');
    
    cells.forEach((cell) => {
      // Limpiar puntos anteriores
      const existingDots = cell.querySelectorAll('.task-dot-container-mobile');
      ...
      if (!dayDate || isNaN(dayDate.getTime())) {
        ...
        const monthElement = cell.closest('.calendar-month-mobile');
        if (!monthElement) return;
        
        // Obtener el texto del caption del mes (ej: "noviembre 2025")
        const captionLabel = monthElement.querySelector('.calendar-caption-label-mobile');
      ...
      // Crear contenedor para los puntos - MOBILE: más compacto
      const dotsContainer = document.createElement('div');
      dotsContainer.className = 'task-dot-container-mobile';
      ...
      // MOBILE: puntos más pequeños (4px en lugar de 5px tablet o 6px desktop)
    ...
    return () => {
      ...
      const containers = calendarContainer.querySelectorAll('.task-dot-container-mobile');
  ...
  return (
    <div 
      ref={calendarRef} 
      className={cn("calendar-container-mobile w-full", className)} 
    ...
    >
      <Calendar
        ...
        className="w-full"
        classNames={{
          months: "calendar-months-mobile",
          month: "calendar-month-mobile",
          caption: "calendar-caption-mobile",
          caption_label: "calendar-caption-label-mobile",
          nav: "calendar-nav-mobile",
          nav_button: "calendar-nav-button-mobile",
          nav_button_previous: "calendar-nav-button-mobile calendar-nav-button-previous-mobile",
          nav_button_next: "calendar-nav-button-mobile calendar-nav-button-next-mobile",
          table: "calendar-table-mobile",
          head_row: "calendar-head-row-mobile",
          head_cell: "calendar-head-cell-mobile",
          row: "calendar-row-mobile",
          cell: "calendar-cell-mobile",
          day: "calendar-day-mobile",
          day_range_start: "calendar-day-mobile day-range-start-mobile",
          day_range_end: "calendar-day-mobile day-range-end-mobile",
          day_selected: "calendar-day-mobile",
          day_today: "calendar-day-mobile day-today-mobile",
          day_outside: "calendar-day-mobile day-outside-mobile",
          day_disabled: "calendar-day-mobile",
          day_range_middle: "calendar-day-mobile",
          day_hidden: "calendar-day-hidden-mobile",
        }}
      />
      <DayPopup
        open={isPopupOpen}
