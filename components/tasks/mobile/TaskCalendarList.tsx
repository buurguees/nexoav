...
/**
 * Listado mensual de tareas - Versión Mobile
 * 
 * Muestra 1 columna (todas las categorías apiladas) para optimizar el espacio vertical
 */
export function TaskCalendarList({
  ...
  if (monthTasks.length === 0) {
    return (
      <div className={cn("task-calendar-list-empty-mobile", className)}>
        <p style={{ 
          textAlign: "center", 
  ...
  return (
    <div 
      className={cn("task-calendar-list-mobile", className)}
      style={{
