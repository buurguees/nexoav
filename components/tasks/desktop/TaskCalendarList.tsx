...
/**
 * Listado mensual de tareas asociado a la vista de Calendar18.
 * 
 * Muestra todas las tareas del mes en curso, permitiendo entender qué se hace y cuándo,
 * sin entrar todavía en el nivel de detalle total que tendrá la vista completa de tareas.
 * 
 * Trabaja sobre el mismo rango temporal que el calendario mensual.
 * Muestra más información que el widget de Resumen pero menos que la vista completa.
 * 
...
export function TaskCalendarList({
  ...
  if (monthTasks.length === 0) {
    return (
      <div className={cn("task-calendar-list-empty", className)}>
        <p style={{ 
          textAlign: "center", 
  ...
  return (
    <div 
      className={cn("task-calendar-list", className)}
      style={{
