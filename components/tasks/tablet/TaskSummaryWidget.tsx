...
export interface TaskSummaryWidgetProps {
  ...
  referenceDate?: Date;
  /** Número máximo de tareas a mostrar (por defecto: 8 en tablet) */
  maxTasks?: number;
...
/**
 * Widget compacto que muestra un resumen de las tareas más relevantes del periodo visible - Versión Tablet
 * 
...
export function TaskSummaryWidget({
  tasks,
  referenceDate,
  maxTasks = 8, // TABLET: mostrar 8 tareas por defecto
  onTaskClick,
  className,
  ...
  if (relevantTasks.length === 0) {
    return (
      <div 
        className={cn("task-summary-widget-empty-tablet", className)}
        style={{
          backgroundColor: "var(--background-secondary)",
          border: "1px solid var(--border-medium)",
          borderRadius: "var(--radius-md)",
          padding: "var(--spacing-md)", // TABLET: padding reducido
          width: "100%",
          maxWidth: "100%", // TABLET: sin max-width limitante
          fontFamily: "inherit",
        }}
      >
        <div style={{
          padding: "var(--spacing-sm)", // TABLET: padding reducido
          textAlign: "center",
          color: "var(--foreground-secondary)",
          fontSize: "13px", // TABLET: fuente ligeramente más pequeña
        }}>
  ...
  return (
    <div 
      className={cn("task-summary-widget-tablet", className)}
      style={{
        backgroundColor: "var(--background-secondary)",
        border: "1px solid var(--border-medium)",
        borderRadius: "var(--radius-md)",
        padding: "var(--spacing-md)", // TABLET: padding reducido (de lg a md)
        width: "100%",
        maxWidth: "100%", // TABLET: sin max-width limitante
    ...
    >
      <div style={{
        marginBottom: "var(--spacing-sm)", // TABLET: margin reducido
        paddingBottom: "var(--spacing-xs)", // TABLET: padding reducido
        borderBottom: "1px solid var(--border-medium)"
      }}>
        <h3 style={{
          marginBottom: "var(--spacing-xs)",
          fontSize: "16px", // TABLET: fuente ligeramente más pequeña
        }}>
          Próximas tareas
        </h3>
        <p style={{
          fontSize: "11px", // TABLET: fuente más pequeña
          margin: 0,
        }}>
      ...
      <div style={{
        ...
        gap: "var(--spacing-xs)", // TABLET: gap reducido
        width: "100%",
        ...
        {relevantTasks.map((task) => {
          ...
          return (
            <div
              ...
              style={{
                display: "flex",
                flexDirection: "row", // TABLET: fila para población y fechas lado a lado
                alignItems: "flex-end", // TABLET: alinear al final (fechas con población)
                justifyContent: "space-between",
                gap: "var(--spacing-xs)", // TABLET: gap entre población y fechas
                padding: "var(--spacing-xs)", // TABLET: padding muy reducido
                borderRadius: "var(--radius-sm)",
                backgroundColor: isTaskToday ? "var(--background-tertiary)" : "var(--background)",
                border: `2px solid ${category.color}`, // TABLET: borde de color para categoría
            ...
            >
              ...
              <div style={{
                ...
                flex: "1 1 auto", // TABLET: ocupar el espacio disponible, puede crecer
                minWidth: 0, // TABLET: permitir que se trunque
                maxWidth: "calc(100% - 70px)", // TABLET: dejar espacio mínimo para las fechas (70px)
                gap: "2px", // TABLET: pequeño espacio entre título y población
                overflow: "hidden", // Evitar desbordamiento
              }}>
                {/* Título de la tarea */}
                <h4 style={{
                  ...
                  overflow: "hidden",
                  textOverflow: "ellipsis", // TABLET: tres puntitos suspensivos si se corta (responsive)
                  whiteSpace: "nowrap", // TABLET: una sola línea
                  margin: 0,
                  fontSize: "12px", // TABLET: fuente ajustada
                  fontWeight: "var(--font-weight-medium)",
                  color: "var(--foreground)",
                  width: "100%", // TABLET: ocupar todo el ancho disponible del contenedor
                  maxWidth: "100%", // TABLET: no exceder el ancho del contenedor
                  boxSizing: "border-box",
                }}>
                  {task.title}
                </h4>
                ...
                {/* Población (ubicación) */}
                <span style={{
                  fontSize: "10px", // TABLET: fuente más pequeña para población
                  color: "var(--foreground-secondary)",
                  overflow: "hidden",
              ...
              {/* Fechas - ocupan la mitad derecha */}
              <span style={{
                fontSize: "10px", // TABLET: fuente más pequeña
                color: "var(--foreground-secondary)",
                flex: "0 0 auto", // TABLET: no crecer, tamaño fijo
                whiteSpace: "nowrap", // TABLET: no hacer wrap
                marginLeft: "var(--spacing-xs)", // TABLET: espacio entre contenido izquierdo y fechas
                minWidth: "60px", // TABLET: ancho mínimo para fechas
                maxWidth: "70px", // TABLET: máximo ancho para fechas (ajustado para dar más espacio al título)
                overflow: "hidden",
                textOverflow: "ellipsis",
                textAlign: "right", // TABLET: alinear fechas a la derecha
              }}>
                {dateLabel}
              </span>
            </div>
