...
/**
 * Listado mensual de tareas - Versión Tablet Portrait
 * 
 * Muestra 2 columnas (2 categorías por fila) para optimizar el espacio
 */
export function TaskCalendarList({
  ...
  if (monthTasks.length === 0) {
    return (
      <div className={cn("task-calendar-list-empty-tablet", className)}>
        <p style={{ 
          textAlign: "center", 
  ...
  return (
    <div 
      className={cn("task-calendar-list-tablet", className)}
      style={{
